...
public class OdevSorusu02 {
	...
	public static void main(String[] args) {
		...
		//tum elemanların toplamını birer birer bulan  ve 
		//herbir sonucu yeni bir array’in elemanı yapan ve
		//yeni array’i ekrana yazdıran bir program yazınız  { {1,2,3}, {4,5}, {6,7} } 
